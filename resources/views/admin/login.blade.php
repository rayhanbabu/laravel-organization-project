				...
				<h5></h5>
				  ...
				  <form method="post" action="{{url('admin/login')}}"  class="myform"  enctype="multipart/form-data" >
		      		...
		      		<div class="form-group">
		      			<input type="text" class="form-control rounded-left" autocomplete="off"  name="admin_name" placeholder="Username" required>
		      		</div>
	           
				 <div class="form-group ">
	              <input type="password" class="form-control rounded-left" id="pass"  name="admin_password" placeholder="Password" required>
	            	...
	            	<div class="w-50">
	            		<label class="checkbox-wrap checkbox-primary">Remember Me
								...
								<div class="w-50 text-md-right">
									<a href="{{url('admin/forget')}}">Forgot Password</a>
								</div>
	            </div>
	          </form>
	        </div>
